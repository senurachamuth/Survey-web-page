                        ...
                        <div class="no-gutters">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="Address" class="form-control" placeholder="Enter your home Address" required>
                                </div>

                                <div class="form-group">
                                    <p class="login-card-footer-text text-dark text-left">5.&nbsp;Enter your Job</p>
                                    <label for="job" class="sr-only">Enter your Job</label>
                                    <input type="text" name="job" id="Address" class="form-control" placeholder="Enter your Job" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="food" id="Address" class="form-control" placeholder="What is your Favorite food?" required>
                                </div>
                                    ...
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="burgerVSSalad" value="burger" checked>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="burgerVSSalad" value="salad">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="Agegap" value="16 years or younger."  checked>
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="Agegap" value="16-25.">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="Agegap" value="25-36.">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="Agegap" value="36-45.">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="Agegap" value="45-56.">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="Agegap" value="56-65">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label for="chkNo">
                                                    <input type="radio" id="chkNo" name="chkPassPort" value="Yes" checked>
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label for="chkYes">
                                                    <input type="radio" id="chkYes" name="chkPassPort" value="No">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <p class="login-card-footer-text text-dark text-left">i.&nbsp;If you select yes why?</p>

                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="why" value="They are quick">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="why" value="I am too busy to cook">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="why" value="I do not like homemade foods">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="why" value="I do not know how to cook">
                                                    <span class="input__box"></span>
                                ...
                                <!--Radio button name why-->
                                <div class="form-group">
                                    <p class="login-card-footer-text text-dark text-left">ii.&nbsp;If you select No why?</p>
                                    <label for="date" class="sr-only">If you select No why?</label>
                                    <input type="text" id="txtPassportNumber" name="why" class="form-control" placeholder="If you select No why?" disabled="disabled">
                                </div>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="foodeveryweek" value="1-2 times" checked>
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="foodeveryweek" value="3-4 times">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="foodeveryweek" value="5-6 times">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="foodeveryweek" value="7 times or more">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="mealplan" value="Yes" checked>
                                                    <span class="input__box"></span>
                                                    <span class="text-size">Yes</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="mealplan" value="No">
                                                    <span class="input__box"></span>
                                                    <span class="text-size">No</span>
                                                </label>
                                            </div>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="microwave" value="1-2 times a week" checked>
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="microwave" value="2-3 times a week">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="microwave" value="3-4 times a week">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="microwave" value="4-5 times a week">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="microwave" value="More than 5 times a week">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="mealtime" value="Yes" checked>
                                                    <span class="input__box"></span>
                                                    <span class="text-size">Yes</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="mealtime" value="No">
                                                    <span class="input__box"></span>
                                                    <span class="text-size">No</span>
                                                </label>
                                            </div>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="family" value="Yes" checked>
                                                    <span class="input__box"></span>
                                                    <span class="text-size">Yes</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="family" value="Sometimes">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="money" value="400 - 800" checked>
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="money" value="800 - 1200">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="money" value="200- 1600">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="money" value="1600-2000">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="money" value="More than Rs 2400">
                                                    <span class="input__box"></span>
                                ...
                                <div class=" theme-light preload">
                                    <div class="center">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="coupons" value="Always" checked>
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-size text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="coupons" value="Never">
                                                    <span class="input__box"></span>
                                            ...
                                            <div class="col-12 text-left input input--radio input--primary">
                                                <label>
                                                    <input type="radio" name="coupons" value="Sometimes">
                                                    <span class="input__box"></span>
                                                    <span class="text-size">Sometimes</span>
                                                </label>
                                            </div>
                                ...
                                <!--<input name="Submit" id="login" type="submit" value="Submit">-->
                                <input name="submit" id="login" class="btn btn-block login-btn mb-4" type="submit" value="Add">
